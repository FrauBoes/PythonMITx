...
def playGame(wordList):
    ...
    while True:
        ...
        if choice1 == 'e':
            ...
            while True:
                computer_human = input('Enter u to have yourself play, c to have the computer play: ')
                if computer_human != 'u' and computer_human != 'c':
                    print('Invalid command.')
                elif computer_human == 'u':
                    previousHand = dealHand(HAND_SIZE)
                    playHand(previousHand, wordList, HAND_SIZE)
                    break
                elif computer_human == 'c':
                    previousHand = dealHand(HAND_SIZE)
